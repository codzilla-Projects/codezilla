...
?>
                            ...
                            <div class="row justify-content-center d-block">
                                <div class="col-lg-10 col-md-10  <?php if($text_align == 'center'){echo "m-auto w-57 "; }else{  echo"pr-5 w-64  "; }?>" >
                                    ...
                                    <div class="caption <?=  $text_align;?> text-<?=  $text_align;?>">
                                        <h1 class="data-splitting"><?php the_title(); ?></h1>
                                        <p><?php the_content(); ?></p>
                                        <?php
            ...
            <div class="row">
                <div class="col-lg-6 valign">
                    <div class="content">
                        ...
                        <?php the_content();?>
                        <div class="w-40">
                            <a href="https://codzilla.net/about-us" class="simple-btn custom-font mt-30 wow data-splitting" style="float: left;margin-right: 38%;"><span><?php _e('Know More','codzilla'); ?></span></a>
                        </div>
                        <div class="w-60">
                            <a href="<?= get_option('codzilla_profile'); ?>" class="simple-btn1 custom-font mt-30 wow data-splitting"><span><?php _e('Download Company Profile','codzilla'); ?></span></a>
                        </div>
    ...
    <!-- ==================== End works ==================== -->
        ...
        <!-- ==================== Start Products ==================== -->
    <section class="products section-padding sub-bg" style="display:none;">
        <div class="container">
            <div class="sec-head custom-font tr-head">
                <h6><?php _e('Best Producst','codzilla'); ?></h6>
                <h3><?php _e('Products','codzilla'); ?>.</h3>
                <span class="tbg"><?php _e('Products','codzilla'); ?></span>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">      
                <div class="col-lg-6 wow fadeInUp p-0" data-wow-delay=".3s">
                    <div class="step-item ">
                        <img class="lazyload" data-src="<?= CODZILLA_URL .'assets/img/product.jpg' ?>" width="675" height="450" alt="codezilla">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp p-0" data-wow-delay=".3s">
                    <div class="about p-5">
                        <div class="content">
                            <div class="sub-title">
                                <h6><?php _e('Product Title','codzilla'); ?></h6>
                                <span></span>
                                <span></span>
                                <span></span>
                            </div>
                            <h3 class="co-tit custom-font wow data-splitting"><?php _e('Product Description','codzilla'); ?></h3>
                            <p class="wow fadeInUp" data-wow-delay=".4s"><?php _e('We are Codezilla. We create award-winning websites,
                                ...
                                erat. Ut dictum nisi masvitp.','codzilla'); ?></p>
                            <p class="mt-10 wow fadeInUp" data-wow-delay=".4s"><?php _e('Nulla metus metus ullamcorper vel tincidunt
                                sed euismod nibh volutpat velit
                                class
                                aptent taciti sociosqu ad litora.','codzilla'); ?></p>
                            <a href="#0" class="simple-btn custom-font mt-30 wow"><span><?php _e('Know More','codzilla'); ?></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp p-0" data-wow-delay=".3s">
                    <div class="about p-5">
                        <div class="content">
                            ...
                            <p class="mt-10 wow fadeInUp" data-wow-delay=".4s"><?php _e('Nulla metus metus ullamcorper vel tincidunt
                                ...
                                class
                                aptent taciti sociosqu ad litora.','codzilla'); ?></p>
                            <a href="#0" class="simple-btn custom-font mt-30 wow data-splitting"><span><?php _e('Know More','codzilla'); ?></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp p-0" data-wow-delay=".3s">
    ...
    <section class="testimonials section-padding bg-img parallaxie" data-background="<?php echo CODZILLA_URL .'assets/img/BG-testimonials.webp' ; ?>" data-overlay-dark="10">
        <div class="container position-re">
            <div class="sec-head custom-font text-center">
                <h6 class="wow fadeIn" data-wow-delay=".5s"><?php _e('What Peapole Says?','codzilla'); ?></h6>
                <h3 class="wow data-splitting"><?php _e('Testimonials.','codzilla'); ?></h3>
   ...
   <!-- ==================== Start Blog ==================== -->
    ...
    <section class="blog-grid section-padding" style="display:none;">
        <div class="container">
            <div class="sec-head custom-font text-center">
                <h6 class="fadeIn" data-wow-delay=".5s"><?php _e('Latest News','codzilla'); ?></h6>
                <h3 class="wow data-splitting"><?php _e('Our Blog.','codzilla'); ?></h3>
                <span class="tbg"><?php _e('Blog','codzilla'); ?></span>
            </div>
            <?php
                $no = 3; 
                $first_flag = .3;
            ...
            <div class="row">
                ...
                ?>
                <div class="col-lg-4">
                    <div class="item list md-mb50 wow fadeInUp" data-wow-delay="<?= $first_flag ?>s">
                        <div class="img">
                            <img class="lazyload" data-src="<?php the_post_thumbnail_url(); ?>" alt="<?php the_title(); ?>" width="370" height="301">
                        </div>
                        <div class="cont sub-bg">
                            ...
                            <div class="btn-more custom-font">
                                <a href="<?php the_permalink(); ?>" class="simple-btn"><?php _e('Read More','codzilla'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
                <?php $first_flag = $first_flag + .3; endwhile;?>
            </div>
            <?php  wp_reset_query(); endif ?>
            <div class="smore custom-font d-flex justify-content-center mt-30">
                <a class="effect effect-2" href="<?php bloginfo('url'); ?>/blog/"><?php _e('Discover More','codzilla'); ?></a>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-8 col-lg-9">
                    <div class="content sm-mb30">
                        <h6 class="wow data-splitting"><?php _e('Let’s Talk','codzilla'); ?></h6>
                        <h2 class="wow custom-font data-splitting"><?php _e('about your ','codzilla'); ?><b><?php _e('next project','codzilla'); ?></b>.</h2>
                    </div>
                </div>
